...
class Network(torch.nn.Module):
    ...
    def __init__(
        ...
        self.batch_norm = torch.nn.ModuleList() ## ADDED JG
        ...
        for _ in range(layers):
            ...
            self.batch_norm.append(BatchNorm(irreps))
...
#         self.batch_norm.append(BatchNorm(self.irreps_out))
